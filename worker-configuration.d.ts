/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3a293cf55f2bf0767154e3b6fce0414a)
// Runtime types generated with workerd@1.20260415.1 2026-04-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "BlogGenerationOrchestrator";
	}
	interface Env {
		KV: KVNamespace;
		D1: D1Database;
		...
		BLOG_ORCHESTRATOR: DurableObjectNamespace<import("./src/worker").BlogGenerationOrchestrator>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_API_KEY" | "GOOGLE_MODEL_NAME" | "AUTO_GENERATE_ON_DEV_START">> {}
}
